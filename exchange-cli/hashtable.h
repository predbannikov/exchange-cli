...
static slist* slist_add(slist** ls, void* key, OrderId val);
...
slist* table_insert(table_t* tb, void* key, OrderId val);
int    iter_each(iter_t* it, table_t* tb, void** key, OrderId* val);
